...
public class Config {
    ...
    public static final ModConfigSpec.ConfigValue<String> KISS_MESSAGE = BUILDER.comment("Message shown to the kissed player (use %s for player name)").define("kissMessage", (Object)"%s kissed you!");
    public static final ModConfigSpec.ConfigValue<String> KISS_PROMPT_MESSAGE = BUILDER.comment("Message shown to the kissing player (use %s for player name)").define("kissPromptMessage", (Object)"You kissed %s!");
    public static final ModConfigSpec.ConfigValue<String> SELF_KISS_ERROR_MESSAGE = BUILDER.comment("Error message when trying to kiss yourself").define("selfKissErrorMessage", (Object)"You can't kiss yourself!");
    public static final ModConfigSpec.ConfigValue<String> COOLDOWN_ERROR_MESSAGE = BUILDER.comment("Error message when command is on cooldown (use %d for seconds)").define("cooldownErrorMessage", (Object)"Wait %d seconds before kissing again!");
    ...
    public static int getCommandCooldown() {
        return (Integer)COMMAND_COOLDOWN.get();
    }

    public static int getMaxSneakParticles() {
        return (Integer)MAX_SNEAK_PARTICLES.get();
    }

    public static double getSneakTriggerRadius() {
        return (Double)SNEAK_TRIGGER_RADIUS.get();
    }

    public static double getMaxViewAngleDegree() {
        return (Double)MAX_VIEW_ANGLE_DEGREE.get();
    }

    public static boolean isKissCommandEnabled() {
        return (Boolean)ENABLE_KISS_COMMAND.get();
    }
}